...
### In assignment 1(Find periodicity with Fourier Transforms in the time series from HW11), I worked with Qiuyao Liu(ql459), Minqi Lu(ml4922), and Jiawen Liang(jl9760).
...
### In assignment 2(Cluster zipcodes), I work individually.
